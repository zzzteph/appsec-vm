...
Route::get('admin_super_login_v3ry_v3ry_very_s3cr3t', [MainController::class, 'admin'])->name('admin');
...
Route::get('secret_flag',[MainController::class, 'flag'])->name('secret_flag');
