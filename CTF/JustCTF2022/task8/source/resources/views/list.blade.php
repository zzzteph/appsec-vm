...
<body>
    <div class="">
      ...
      <nav class="navbar py-4">
        <div class="container is-fluid">
          ...
          <div class="navbar-menu">
			...
			<a class="navbar-item" href="/secret_flag_2">Flag</a>
			@endif
        ...
        <div class="container">
          <div class="columns is-multiline is-centered">
            <div class="column is-8 has-text-centered">
              ...
              <h2 class="mt-2 mb-4 is-size-1 is-size-3-mobile has-text-weight-bold">Are you ready for our new App?</h2>
              <p class="subtitle has-text-grey mb-5">Our app will be available at 24.12.2025, so you can leave your message for me. I will review them from time to time. </p>
              <div class="mb-6"></div>
	  ...
	  <div class="columns is-multiline is-centered">
		<div class="column is-8 is-4-desktop has-text-centered">

		  <h3 class="mb-5 is-size-4 has-text-weight-bold" contenteditable="false">Drop us a message</h3>
		   <form method="POST" action="{{route('post')}}">
						@csrf

			<div class="field">
			  <div class="control">
				<textarea class="textarea" name="message" placeholder="e.g. Hello world"></textarea></div>
			</div>

			<button class="button is-primary mb-3 is-fullwidth">Send!</button>
		  </form>
...
<section class="section">
  <div class="container">
    <div class="columns is-multiline is-centered">
	  ...
	  <a href="{{route('view',['message_id'=>$message->id])}}">
        <div class="mb-4 box p-6 is-relative has-background-light">
          ...
          <p class="subtitle has-text-grey">{{$message->short_message}}</p>
        </div>
		</a>
        <p class="has-text-grey has-text-centered">{{$message->from}} at {{$message->created_at}}</p>
      </div>
    </div>
  </div>
</section>
