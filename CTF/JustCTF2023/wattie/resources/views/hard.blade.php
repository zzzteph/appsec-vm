...
<div class="flex-container">
    ...
    <span> are more agressive and jump more often!</span>
</div>

<div class="flex-container">
    <figure class="image is-32x32">
        <img src="https://wattie.justctf.online/bear.svg" alt="Description">
    </figure>
    <span> will strike with the claw for 8 fish.</span>
</div>
...
updateScoreDisplay() {
 ...
 userUpdate(score) {
    ...
    let apiUrl = `/api/game/${this.gameId}`;
