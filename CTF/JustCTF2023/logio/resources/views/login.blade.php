    ...
    <div class="columns is-multiline is-centered">
      <div class="column is-8 is-5-desktop">
        <div class="box p-6 has-background-light has-text-centered">
          <span class="has-text-grey-dark" contenteditable="false">Sign In</span>
          <h3 class="mb-5 is-size-4 has-text-weight-bold" contenteditable="false">Access the wallet</h3>
		  ...
		  @csrf
            ...
            <button class="button is-primary mb-4 is-fullwidth">Sign In</button>
