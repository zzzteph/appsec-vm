        ...
        <div class="container">
          <div class="columns is-multiline is-centered">
            <div class="column is-8 has-text-centered">
              ...
              <h2 class="mt-2 mb-4 is-size-1 is-size-3-mobile has-text-weight-bold">CrptIO V2</h2>
              <p class="subtitle has-text-grey mb-5">The place to manage all crypto assets. 
      Say goodbye to fiat old world. New security for the new Crypto World</p>
        ...
        <div class="container">
          <div class="columns is-multiline is-centered">
            <div class="column is-8 has-text-centered">
              ...
              <div class="buttons is-centered">
					<a class="button is-primary is-large" href="/kek42v2.txt">Generate your own phrase with KEK42v2 Security </a>
			</div>
            </div>
          </div>
        </div>
